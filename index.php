...
<head>
    ...
    <base href="https://gamesheet.000webhostapp.com/">
...
<body>
    <?php
    $url = "https://gamesheet.000webhostapp.com/api/games.php";

    $dadosAPI = file_get_contents($url);

    $dadosGames = json_decode($dadosAPI);

    $url2 = "https://gamesheet.000webhostapp.com/api/recomendados.php";

    $dadosAPI2 = file_get_contents($url2);

    $dadosRecomendados = json_decode($dadosAPI2);

    $url3 = "https://gamesheet.000webhostapp.com/api/promo.php";

    $dadosAPI3 = file_get_contents($url3);

    $dadosPromo = json_decode($dadosAPI3);

    $url4 = "https://gamesheet.000webhostapp.com/api/lanca.php";
    ...
    <header>
        <nav class="navbar navbar-expand-lg header_back" data-bs-theme="dark">
            <div class="container-fluid">
                <a class="navbar-brand" href="https://gamesheet.000webhostapp.com/"><img src="images/Logo 1.svg" alt=""></a>
    ...
    <footer>
        ...
        <section class="infos">
            <div>
                <h3>Redes Sociais</h3>
                <a href="https://wa.me/5544998030402" target="_blank"><i class="fa-solid fa-phone"></i></a>
