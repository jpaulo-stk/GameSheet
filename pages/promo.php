<?php
$dados = $dadosPromo->$codigo;
?>

<?php
$dadosFotos = file_get_contents("http://localhost/gamesheet/api/fotosPromo.php");
    ...
    <section class="text-center">
        ...
        <div class="d-flex justify-content-center">
            ...
            <div class="row game_img space" data-aos="zoom-in">
                <?php
                $i = 1;
                foreach ($dadosFotos as $dados3) {
                ?>
                    <div class="d-flex col-12 col-md-3 p-2 pt-0">
                        <a href="<?= $dados3->foto ?>" title="Aumentar Foto" data-fslightbox><img src="<?= $dados3->foto ?>" alt="Foto" <?= $i ?> class="w-100 joao d-none d-lg-block"></a>
                    </div>
                <?php
                    $i++;
                }
        ...
        <div class="joao back_card_m rounded-0" data-aos="flip-down">
            <div class="p-1">
                <div class="d-flex justify-content-center align-items-center">
                    <p class="pe-4 fw-bold mt-3">R$: <?=$dados->preco?></p>
                    <div>
                        <button type="button" class="btn game_back rounded-0 border-0">
                            <a href="<?= $dados->jogar ?>" target="_blank" class="text_azul p-2 text-white fw-bold">Comprar</a>
                        </button>
...
<div class="d-flex justify-content-center m-4" data-aos="zoom-in">
    <div class="card joao rounded-0 text-center" style="width: 18rem;">
        ...
        <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item text-white back_card_m">Data de lançamento: <?=$dados->data?></li>
        </ul>
    </div>
</div>