...
<div>
    <section class="text-center">
        <img src="<?= $dados->images ?>" alt="Foto" class="game_img joao mb-3">


        <div class="d-flex justify-content-center">
            <div class="row game_img space">
                <?php
                $i = 1;
                foreach ($dadosFotos as $dados2) {
                ?>
                    <div class="d-flex col-12 col-md-3 p-2 pt-0">
                        <a href="<?= $dados2->foto ?>" title="Aumentar Foto" data-fslightbox><img src="<?= $dados2->foto ?>" alt="Foto" <?= $i ?> class="w-100 joao"></a>
                    </div>
                <?php
                    $i++;
                }
    ...
    <section class="jogar mt-2 d-none d-lg-block">
        <div class="joao back_card_m rounded-0">
            <div class="p-1">
                <div class="d-flex justify-content-center align-items-center">
                    <p class="pe-4 fw-bold mt-3">Gratuito para jogar</p>
                    <div>
                        <button type="button" class="btn game_back rounded-0 border-0">
                            <a href="<?= $dados->jogar ?>" class="text_azul p-2 text-white fw-bold">Jogar</a>
                        </button>
